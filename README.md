...
Generated plots (SVG/HTML) appear next to the script and are gitignored — the canonical rendered output lives under `site/`. Open the per-lesson SVGs in any browser, or run `make html` to build the interactive Plotly view at `site/index.html`.
...
**Status: Planned** | [`site/04-geometry-and-material-maps.md`](site/04-geometry-and-material-maps.md)
...
**Status: Planned** | [`site/05-poisson-laplace-bvp.md`](site/05-poisson-laplace-bvp.md)
...
**Status: Planned** | [`site/06-magnetostatics.md`](site/06-magnetostatics.md)
...
**Status: Planned** | [`site/07-faraday-induction.md`](site/07-faraday-induction.md)
...
**Status: Planned** | [`site/08-maxwell-equations.md`](site/08-maxwell-equations.md)
...
**Status: Planned** | [`site/09-em-waves.md`](site/09-em-waves.md)
...
**Status: Planned** | [`site/10-fdfd-frequency-domain.md`](site/10-fdfd-frequency-domain.md)
...
**Status: Planned** | [`site/11-fdtd-simulation.md`](site/11-fdtd-simulation.md)
...
**Status: Planned** | [`site/12-waveguides-and-radiation.md`](site/12-waveguides-and-radiation.md)
...
**Status: Planned** | [`site/13-transmission-lines-and-antennas.md`](site/13-transmission-lines-and-antennas.md)
...
**Status: Planned** | [`site/14-capstone-device-simulation.md`](site/14-capstone-device-simulation.md)
...
site/                     # rendered notebooks for GitHub display (committed)
...
Each lesson notebook follows a consistent structure: Learning Objectives → Background → Theory → Simulations → Exercises → Connections to Upcoming Lessons. Edit the source at `notebooks/<slug>.md`, then run `make notebooks` to regenerate `site/`.
