# rustlab_em — render lesson sources to a top-level site/ for GitHub display.
#
...
html: ## Build interactive HTML at site/index.html (auto-generated entry page + per-notebook html)
	rustlab notebook render notebooks --format html --output $(abspath $(SITE)) --title "rustlab_em"
